...
contract TBL4Token is BurnableToken {
  ...
  uint256 public constant INITIAL_SUPPLY = 40 * 1 ether; // example: 20 eth hardcap + possible 20% + 40% devs and partners
...
contract TBL4TokenSale {
    ...
    function TBL4TokenSale() public {
        ...
        multisigFunds = 0x4530716571c460fd9781F4fB5F6b5d982158F987;
        devs = 0x2Dd3EEc9df4de6B48c1730527e420ce10e3299a5;
        partners = 0x88B7B046E44b79a46ab38800832E5E9aAac4CE57;
   ...
   function reserveFunds() public payable {
       ...
       if (!stopped && now > startPreSale && now < endPreSale)
       {
           ...
           require(_totalFundedEth < 10 * 1 ether); // todo: change to real presale limit
